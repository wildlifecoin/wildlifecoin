...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Wildlifecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"wildlifecoin.com", "wildlifecoin.com"},
    {"eu.wildlifecoin.com", "eu.wildlifecoin.com"},
    {"asia.wildlifecoin.com", "asia.wildlifecoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Wildlifecoin is probably already running."), addrBind.ToString().c_str());
        else
